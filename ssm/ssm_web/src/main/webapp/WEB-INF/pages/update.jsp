          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                    ...
                    <option value="安庆"  ${user.address=="安庆" ?"selected":""}>安庆</option>
                    <option value="合肥"  ${user.address=="合肥" ?"selected":""}>合肥</option>
                    <option value="青岛"  ${user.address=="青岛" ?"selected":""}>青岛</option>
                    <option value="西藏"  ${user.address=="西藏" ?"selected":""}>西藏</option>
                    <option value="兰州"  ${user.address=="兰州" ?"selected":""}>兰州</option>
            </select>
          </div>
